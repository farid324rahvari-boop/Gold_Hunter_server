...
function runStrategies(d, fund) {
  ...
  const strategies = [trend, structure, sweep, momentum, fibonacci, divergenceS, fundamental, sessionBreakout];
...
const DIAGNOSTIC_ONLY_STRATEGY_IDS = new Set(['RSI_DIVERGENCE']);
